...
# Create the video as final_clip using the previous logic
# Assuming json_data and scene_images are already defined as per previous examples


def create_final_clip(json_data, scene_images):
    clips = []
...
final_clip = create_final_clip(json_data, scene_images)
...
json_data = [
    ...
    {
        "description": "Why HPC BRASIL?\nChoosing HPC BRASIL means partnering with...",
        "duration": 5,
    },
    {
        "description": "Our Promise\nAt HPC BRASIL, we promise to deliver innovative...",
        "duration": 5,
    },
    {
        "description": "Closing Scene\n[Visuals of the HPC BRASIL team working collaboratively...]",
        "duration": 5,
    },
    {
        "description": 'Voiceover: "Get in touch with HPC BRASIL today..."',
        "duration": 5,
    },
]
